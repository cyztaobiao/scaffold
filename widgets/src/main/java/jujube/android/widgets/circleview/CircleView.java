package jujube.android.widgets.circleview;
...
public class CircleView extends View {
    ...
    private Bitmap bitmapPad1;
    private Bitmap bitmapPad2;
    ...
    private void inits() {
        ...
        if (imgSrc != -1) {
            ...
            bitmap = BitmapFactory.decodeResource(getResources(), imgSrc, options);
        }

        bitmapPad1 = Bitmap.createBitmap(bitmap, (int) leftPadding, 0, (int) (bitmap.getWidth() - leftPadding), (int) bitmap.getHeight());
        bitmapShader1 = new BitmapShader(bitmapPad1, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        bitmapPad2 = Bitmap.createBitmap(bitmap, 0, (int) topPadding, (int) bitmap.getWidth(), (int) (bitmap.getHeight() - topPadding));
        bitmapShader2 = new BitmapShader(bitmapPad2, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        matrix.reset();
        matrix.preRotate(rotation, bitmapWidth/2, bitmapWidth/2);
